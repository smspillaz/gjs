...
#include <gjs/debug-connection-private.h>
...
static void
unregister_connection_callback(GjsDebugConnection *debug_connection,
                               gpointer           user_data)
{
...
static void
gjstest_debug_connection_destroy_callback_is_called_on_unregister(void)
{
    ...
    GjsDebugConnection *connection = gjs_debug_connection_new(unregister_connection_callback,
                                                              &data);
...
{
    g_test_add_func("/gjs/debug/connection/called_on_unref", gjstest_debug_connection_destroy_callback_is_called_on_unregister);
